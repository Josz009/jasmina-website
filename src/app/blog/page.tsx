...
const articles = [
  { slug: "presence-is-the-new-productivity", title: "Presence Is the New Productivity", excerpt: "Busyness has become a badge of honor — but constant motion comes at a cost. Real impact requires space to think, feel, and question why. Success is built on clarity, not exhaustion.", category: "Conscious Leadership", date: "February 2026", image: "/images/stock/coaching-session.jpg", readTime: "5 min read" },
  { slug: "conscious-business-mindful-pivoting", title: "Conscious Business: Mindful Pivoting in a Changing World", excerpt: "Success is not measured by how fast you move, but by how mindfully you pivot. Discover how NLP, Gene Keys shadow work, and conscious leadership create sustainable growth and meaningful impact.", category: "Strategy & Mindset", date: "February 2026", image: "/images/stock/financial-charts.jpg", readTime: "7 min read" },
  { slug: "from-greed-to-aspiration", title: "From Greed to Aspiration: Transforming Shadow in Business", excerpt: "Greed is more than a personal flaw — it's a shadow energy that ripples through organizations. By aligning ambition with values, leaders can transform drive into purpose and build impact that lasts.", category: "Shadow Work & Leadership", date: "February 2026", image: "/images/stock/trading-desk.jpg", readTime: "5 min read" },
];
