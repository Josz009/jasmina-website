...
const faqs = [
  { category: "General", icon: "01", questions: [
    ...
    { q: "What makes your approach different from other financial advisors?", a: "I combine deep financial analysis experience (20+ years at AIG) with certified executive coaching (John Maxwell, NLP Master Practitioner). Most advisors give you numbers. I give you numbers AND the decision-making framework to act on them with confidence." },
    ...
    { q: "Where are you located?", a: "I am based in Houston, Texas. I work with clients both locally and remotely. All consultations can be conducted via video call, making my services accessible regardless of your location." },
  ]},
